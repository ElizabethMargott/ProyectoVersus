...
urlpatterns = [
    ...
    path('estudiantes/crear/', views.listar_estudiantes, name="listar_estudiantes"),
    path('crear_estudiantes/', views.crear_estudiantes, name='crear_estudiante'),
    ...
    path('prestamos/crear/', views.listar_prestamos, name="listar_prestamos"),
    path('crear_prestamos/', views.crear_prestamos, name='crear_prestamo'),
